    ...
    .then(function (data) {
      ...
      fetch(url)
        ...
        .then(function (data2) {
          ...
          var cityHeading = $("<h2>")
            .text(cityName + " : " + today)
            .addClass("text-light border-bottom border-dark");
          ...
          var temp = $("<p>").text(todayTemp).addClass("text-light mb-0");
          var wind = $("<p>").text(todayWind).addClass("text-light mb-0");
          var humidity = $("<p>")
            .text(todayHumidity)
            .addClass("text-light mb-0");
          var uvIndex = $("<p>").html(
            `UV Index: <span class="text-light px-2 mb-0 ${setUVColor(
              todayUVIndex
            )}"> ${todayUVIndex} </span>`
